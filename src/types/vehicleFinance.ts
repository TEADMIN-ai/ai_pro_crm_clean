...
export type VehicleFinanceSupplierQuoteDocument = { documentId: string; fileName: string; fileUrl?: string | null; storagePath?: string | null; uploadedAt: string; uploadedBy?: string | null; notes?: string | null };
