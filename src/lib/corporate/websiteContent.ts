...
export const serviceDetails: Record<string, ServiceDetail> = {
  ...
  carSales: { eyebrow: 'Automotive', title: 'Automotive sales support without invented stock or approval claims.', description: 'Torque Empire supports vehicle sourcing, sales coordination, dealer collaboration, customer enquiry handling, vehicle presentation, marketing workflow, and digital follow-up processes.', highlights: ['Vehicle sourcing', 'Sales support', 'Dealer collaboration', 'Customer enquiry support', 'Vehicle presentation and marketing', 'Digital workflow capability'], process: ['Capture the buyer or partner requirement', 'Coordinate sourcing or dealer discussion', 'Prepare presentation and enquiry follow-up', 'Track communication through a structured workflow'], proofPoints: ['The public website does not claim live vehicle availability or finance approval', 'Existing public vehicle and showroom assets support presentation', 'Automotive workflows remain separate from the secure TEOS dashboard'], primaryCta: 'Start an automotive enquiry' },
};
