...
export function buildOpportunityExecutionState(input: { deal: Deal | AnyRecord; contractor?: AnyRecord | null }): OpportunityExecutionState {
  ...
  addAction(actions, "record_submission", "Record Submission", phase === "READY_FOR_SUBMISSION" && f.submissionReviewApproved, f.submissionReviewApproved ? "Opportunity is not ready for submission" : "Complete Submission Review first");
