export const API_ROUTES = {
  ...
  VEHICLE_FINANCE_INVENTORY_CONNECTOR_HEALTH: "/api/vehicle-finance/inventory/connector/health",
  VEHICLE_FINANCE_INVENTORY_CONNECTOR_SYNC: "/api/vehicle-finance/inventory/connector/sync",
  VEHICLE_FINANCE_INVENTORY_CONNECTOR_VALIDATE: "/api/vehicle-finance/inventory/connector/validate",
  VEHICLE_FINANCE_INVENTORY_CONNECTOR_CONFIG: "/api/vehicle-finance/inventory/connector/config",
