...
export const CBAVO_MONTHLY_REVENUE = 2100;
...
export const cbavoClient: HygieneClient = {
  ...
  primaryContactName: "CBAVO Services",
  primaryContactPhone: "CBAVO Services",
  primaryContactEmail: "CBAVO Services",
  billingContact: "CBAVO Services",
...
export const cbavoSites: HygieneSite[] = [
  {
    ...
    suburb: "Florida",
    city: "Roodepoort",
    contactPerson: "CBAVO Services",
    contactPhone: "CBAVO Services",
    binCount: 4,
    binSize: "12L",
    serviceFrequency: "Weekly",
    accessNotes: "Florida Campus Friday collection after 13:00.",
  ...
  },
  {
    ...
    binSize: "12L",
    serviceFrequency: "Weekly",
    accessNotes: "Ontdekkers Campus Friday collection after 13:00.",
    lastServiceDate: "2026-06-19",
    nextServiceDate: "2026-06-26",
    status: "Active",
  },
...
export const cbavoComplianceDocuments: HygieneComplianceDocument[] = [
  ...
  },
  {
    ...
    documentType: "COIDA",
    title: "COIDA",
    registrationNumber: "COIDA upload pending",
    status: "Pending",
    issueDate: null,
    expiryDate: null,
    fileUrl: null,
  ...
  },
  {
    ...
    registrationNumber: "Disposal certificate pending",
    status: "Pending",
    issueDate: null,
    expiryDate: null,
    fileUrl: null,
  ...
  },
  {
    ...
    registrationNumber: "Public liability insurance pending",
    status: "Pending",
    issueDate: null,
    expiryDate: null,
    fileUrl: null,
...
export const cbavoReports: HygieneReport[] = [
  {
    ...
    revenueSummary: CBAVO_MONTHLY_REVENUE,
    createdAt: now,
  },
];
