...
async function getUserProfile(uid: string): Promise<UserProfile | null> {
  ...
  return buildUserProfile((snapshot.data() ?? {}) as Record<string, unknown>);
}
