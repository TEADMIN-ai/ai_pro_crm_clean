...
import SupplierQuoteWorkspace from "@/components/supplier-quotes/SupplierQuoteWorkspace";
...
export default async function DealSupplierQuotesPage({ params }: { params: Promise<{ dealId: string }> }) {
  ...
  try {
    ...
    return (
      <main data-module="dashboard" className="tex-shell">
        <EnterpriseEmptyState title="Supplier quote workspace unavailable" detail="The canonical deal record could not be loaded." />
      </main>
    );
  }
      ...
      <EnterpriseCard className="p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h1 className="tex-title mt-3">Supplier Quotes</h1>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <EnterpriseStatusBadge value={contractorName.includes("Torque Empire") ? "Torque Empire bidder" : "Contractor assigned"} tone="success" />
          </div>
        </div>
      </EnterpriseCard>
