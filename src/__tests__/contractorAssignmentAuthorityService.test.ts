...
function doc(t: string, o: R = {}) { return { id: t, documentId: "DOC-" + t, contractorId, workspaceId: "workspace-a", documentType: t, fileUrl: "https://x/" + t + ".pdf", verified: true, verifiedAt: "2026-07-17T09:20:00.000Z", uploadedAt: "2026-07-17T09:10:00.000Z", expiresAt: Date.parse("2026-09-01T00:00:00.000Z"), status: "verified", ...o }; }
